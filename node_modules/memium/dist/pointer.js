...
import { registerType, Void } from './types.js';
/**
 * A pointer
 */
let Pointer = (() => {
    let _classDecorators = [registerType];
    ...
    var Pointer = class {
        ...
        static {
            ...
            Pointer = _classThis = _classDescriptor.value;
        ...
        #value;
        constructor(type, value, memory = _lastMemory
